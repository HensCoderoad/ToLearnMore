...
import com.wechat.manager.entity.output.*;

import java.io.Serializable;

/**
 * @author: Hens
 * @DateTime: 2019/12/3 23:17
 * @Description: 构建回复消息
 */
public class ReplyMessageUtil implements Serializable {
     ...
     * @return
     */
    public static String sendImageTextMessage(ArticlesOutputMessage message){
        StringBuffer sb = new StringBuffer();
        sb.append("<xml>");
        sb.append("<ToUserName><![ADATA[").append(message.getToUserName()).append("]]></ToUserName>");
        ...
        sb.append("<ArticleCount>").append(message.getArticleCount()).append("</ArticleCount>");
        sb.append("<Articles> ");
